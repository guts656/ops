...
assert.match(batchData, /fileContentBase64: content \? content\.toString\('base64'\) : undefined/, 'Windows upload payload should be base64 encoded for safe JSON transport')
