...
const typeLabel = { test_connection: '测试连接', install_agent: '安装 Agent', reinstall_agent: '重新安装 Agent', restart_agent: '重启 Agent', remanage: '重新纳管', refresh_host_info: '刷新主机信息', pull_host_metrics: '拉取主机指标', diagnose_agent_backend: '诊断 Agent 回连', repair_agent_backend_routes: '修复 Agent 回连路由' }
const transportLabel = { ssh: 'SSH', winrm: 'WinRM' }
